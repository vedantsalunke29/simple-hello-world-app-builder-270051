...
greetingRoutes.get('/', catchAsync(async (c) => {
...
greetingRoutes.post('/', zValidator('json', createGreetingSchema), catchAsync(async (c) => {
...
greetingRoutes.delete('/', catchAsync(async (c) => {
