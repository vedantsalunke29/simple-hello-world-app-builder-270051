...
import { GoogleOAuthGetUserProfile200 } from '@uptiqai/integrations-sdk';
 ...
 */
export async function findOrCreateUser(profile:GoogleOAuthGetUserProfile200, metadata?: Record<string, any>): Promise<User> {
